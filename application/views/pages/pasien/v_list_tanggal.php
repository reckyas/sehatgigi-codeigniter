    ...
    <section class="content">
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Tanggal kedatangan</h3>
        </div>
        <div class="box-body">
          <ul class="list-group">
            <?php foreach ($pasien as $p): ?>
              <li class="list-group-item">
                ...
                <span class="badge badge-pill" style="background: blue;"><a href="<?php echo base_url('pasien/detail/').$this->uri->segment(3).'/'.$p->waktu_berobat ?>" style="color:#fff;"><i class="fa fa-eye"></i></a></span>
              </li>
            <?php endforeach ?>
          </ul>
        </div>
