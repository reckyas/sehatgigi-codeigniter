            ...
            success : function (hasil) {
              ...
              if (hasil.status == 1) {
                ...
                for (var i = 0; i < hasil.data.length; i++) {
                  hasil_pencarian += '<div class="card"><div class="card-header" id="headingOne" style="margin-bottom: 1em;"><div class="row"><div class="col-sm-9"><button type="button" class="btn btn-info btn-sm" data-toggle="collapse" data-target="#collapse'+j+'" aria-expanded="true"><i class="fa fa-eye"></i></button>&nbsp;'+hasil.data[i].nama+'</div><div class="col-sm-3"><button type="button" class="btn btn-primary btn-sm float-right" onclick=daftar_pasien_lama("'+hasil.data[i].id+'")><i class="fa fa-plus"></i></button></div></div></div><div id="collapse'+j+'" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample"><div class="card-body"><ul style="list-style: none;"><li>Ibu kandung : '+hasil.data[i].ibu_kandung+'</li><li>NIK : '+hasil.data[i].nik+'</li></ul></div></div></div>';
                  j++;
                }
                ...
                $('#accordionExample').html(`
                  <i style="color:red;">`+hasil.Pesan+`</i>
                `);
              }
            }
          })
