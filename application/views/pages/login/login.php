...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url()?>">Poliklinik</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body kotak">
    ...
    <?php echo form_open(base_url('login/auth'), 'post'); ?>
      <div class="form-group has-feedback">
        <input type="text" class="form-control inputan" placeholder="Username" name="username" required> 
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control inputan" placeholder="Password" name="password" required>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat tombol-login">Masuk</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
