...
class Layanan extends CI_Controller {
	...
	public function tambah_data_medik()
	{
		...
		$penyakit_lainya = preg_replace("/[^a-zA-Z\']/", "",$this->input->post('penyakit_lainya'));
		$alergi_obat = preg_replace("/[^a-zA-Z\']/", "",$this->input->post('alergi_terhadap_obat'));
		$alergi_makanan = preg_replace("/[^a-zA-Z\']/", "",$this->input->post('alergi_terhadap_makanan'));
